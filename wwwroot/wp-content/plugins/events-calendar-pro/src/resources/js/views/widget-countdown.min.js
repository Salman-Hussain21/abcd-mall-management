...
tribe.events = tribe.events || {}, tribe.events.pro = tribe.events.pro || {}, tribe.events.pro.widgets = tribe.events.pro.widgets || {}, tribe.events.pro.widgets.countdown = {},
    function($, obj) {
        "use strict";
        ...
        obj.selectors = {
            ...
            if (!(timer.seconds <= 0))
                if (timer.seconds -= 1, timer.seconds > 0) timer.elements.days.text(obj.zeroPad(timer.seconds / obj.constants.DAY_IN_SECONDS)), timer.elements.hours.text(obj.zeroPad(timer.seconds % obj.constants.DAY_IN_SECONDS / obj.constants.HOUR_IN_SECONDS)), timer.elements.minutes.text(obj.zeroPad(timer.seconds % obj.constants.HOUR_IN_SECONDS / obj.constants.MINUTE_IN_SECONDS)), timer.elements.seconds.length && timer.elements.seconds.text(obj.zeroPad(timer.seconds % obj.constants.MINUTE_IN_SECONDS));
                else {
                    timer.elements.time.addClass(obj.selectors.hidden.className()), timer.elements.complete.removeClass(obj.selectors.hidden.className());
