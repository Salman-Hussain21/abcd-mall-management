/*! For license information please see public.js.LICENSE.txt */ ! function() {
    ...
    __webpack_require__.n = function(module) {
        ...
        function() {
            ...
            __webpack_require__.r(modules_namespaceObject), __webpack_require__.d(modules_namespaceObject, {
                ...
                default: function() {
                    return underscore_array_methods
                },
                defaults: function() {
                    return defaults
                },
            ...
            var modules_isFunction = isFunction,
                _hasObjectTag = tagTester("Object"),
                hasStringTagBug = supportsDataView && _hasObjectTag(new DataView(new ArrayBuffer(8))),
                isIE11 = "undefined" != typeof Map && _hasObjectTag(new Map),
                isDataView = tagTester("DataView");
            var modules_isDataView = hasStringTagBug ? function(obj) {
            ...
            var modules_isArguments = isArguments;
            ...
            var _getByteLength = shallowProperty("byteLength"),
            ...
            var modules_isTypedArray = supportsArrayBuffer ? function(obj) {
            ...
            var once = modules_partial(before, 2);
            ...
            var underscore_array_methods = _,
                index_default_ = mixin(modules_namespaceObject);
            index_default_._ = index_default_;
            var index_default = index_default_,
                external_jQuery_ = __webpack_require__(311),
            ...
            const MailPoet = {
                Ajax: {
                    ...
                    request: function(method, options) {
                        ...
                        return external_jQuery_default()[method]({
                            url: this.options.url,
                            data: params,
                            success: null,
                            dataType: "json",
                            timeout: this.options.timeout
                        }).then((data => deferred.resolve(data)), ((failedXhr, textStatus) => {
                            let errorData;
                            var errorMessage, xhr;
                            "timeout" === textStatus ? errorData = buildErrorResponse(MailPoetI18n.t("ajaxTimeoutErrorMessage").replace("%d", timeout.toString())) : (errorMessage = MailPoetI18n.t("ajaxFailedErrorMessage"), errorData = (xhr = failedXhr).responseJSON ? xhr.responseJSON : buildErrorResponse(errorMessage.replace("%d", xhr.status))), deferred.reject(errorData)
            ...
            var api = function init(converter, defaultAttributes) {
                ...
                parsley = __webpack_require__(14),
                parsley_default = __webpack_require__.n(parsley);
            var build_module_validateNamespace = function(namespace) {
            ...
            var build_module_validateHookName = function(hookName) {
            ...
            var build_module_createAddHook = function(hooks, storeKey) {
            ...
            var build_module_createRemoveHook = function(hooks, storeKey, removeAll = !1) {
            ...
            var build_module_createHasHook = function(hooks, storeKey) {
                return function(hookName, namespace) {
                    const hooksStore = hooks[storeKey];
            ...
            var build_module_createRunHook = function(hooks, storeKey, returnFirstArg = !1) {
            ...
            var build_module_createCurrentHook = function(hooks, storeKey) {
                return function() {
            ...
            var build_module_createHooks = function() {
                return new _Hooks
            };
            ...
            external_jQuery_default()(($ => {
                ...
                function updateCaptcha(e) {
                    ...
                    if (!captcha || !audioCaptcha) return !1;
                    ...
                    return captcha.setAttribute("src", `${newSrc}&cachebust=${(new Date).getTime()}`), captchaSrc = audioCaptchaSource.getAttribute("src"), hashPos = captchaSrc.indexOf("&cachebust="), newSrc = hashPos > 0 ? captchaSrc.substring(0, hashPos) : captchaSrc, audioCaptchaSource.setAttribute("src", `${newSrc}&cachebust=${(new Date).getTime()}`), audioCaptcha.load(), e && e.preventDefault(), !0
                }
                ...
                function showForm(formDiv) {
                    let showOverlay = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                    if ((formDiv => {
                ...
                $(document).on("keyup", (e => {
                    ...
                    const form = $(element);
                    checkFormContainer(form.closest("div.mailpoet_form")), form.parsley().on("form:validated", (() => {
                ...
                })), $(".mailpoet_captcha_update").on("click", updateCaptcha), $(".mailpoet_captcha_audio").on("click", playCaptcha), $(".mailpoet-manage-subscription").on("submit", (event => {
